...
Тук ако при оператора за присвояване нямахме проверката от по-горе, то тогава щеше да се получи теч на памет. Ето кода, който описва поведението на оператора (тук е без проверката):
